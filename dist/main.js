(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("vue-tools", [], factory);
	else if(typeof exports === 'object')
		exports["vue-tools"] = factory();
	else
		root["vue-tools"] = factory();
...
var install = function install(Vue) {
	...
	(0, _keys2.default)(_prototype2.default).forEach(function (keys) {
		Vue.prototype[keys] = _prototype2.default[keys];
	});

	Vue.use(_filter2.default);
...
prototype.$clone = function (obj) {
  var objType = Object.prototype.toString.call(obj);
  if (objType === "[object Object]" || objType === "[object Array]") {
    var newObj = obj instanceof Array ? [] : {};
    for (var i in obj) {
      newObj[i] = (0, _typeof3.default)(obj[i]) == 'object' ? undefined.$clone(obj[i]) : obj[i];
    }
    return newObj;
  } else {
...
filter.install = function (Vue) {
	...
	Vue.filter('decimalFormat', function (numberStr) {
		var type = typeof numberStr === 'undefined' ? 'undefined' : (0, _typeof3.default)(numberStr);
		if (type === 'string') {
